...
function Home(){
    ...
    return(
        <div className="md:py-[280px] py-[220px] lg:px-[100px] md:px-[50px] px-[25px] bg-[radial-gradient(circle,_#EEAECA_0%,_#94BBE9_100%)] text-black p-6 rounded-xl shadow-lg text-center">
